...
Gere um plano prescritivo completo, rigoroso e altamente calibrado para o seguinte ativo veicular:
- Veículo / Configuração: ${dadosVeiculo || "Citroën C4 Pallas 2009 2.0 16V EW10A Flex Automático Convencional AL4 - Odômetro: 191.706 KM"}
- Regime Operacional de Severidade: ${regimeUso || "SEVERO_URBANO"}

DIRETRIZES TÉCNICAS E DE ENGENHARIA OBRIGATÓRIAS:
1. Descubra e inclua TODOS os subsistemas essenciais com seus respectivos componentes:
   - Motor/Trem de Força (Óleo, Filtros, Velas de Ignição, Kit Correia Dentada HNBR + Tensores, Coxim Hidráulico do Motor)
   - Transmissão (Fluido ATF Mobil LT 71141 / Total Fluide XLD FE, Eletroválvulas BorgWarner do Câmbio AL4)
   - Arrefecimento (Bomba d'Água, Válvula Termostática em Alumínio, Trocador de Calor do Câmbio, Aditivo Orgânico Rosa PSA B71 5110)
   - Freios (Fluido Sintético DOT 4, Pastilhas e Discos Dianteiros/Traseiros)
   - Suspensão/Direção (Bieletas Reforçadas, Buchas Hidráulicas da Bandeja, Coxins Superiores dos Amortecedores, Alinhamento 3D)
   - Fluidos/Insumos (Fluido de Direção Hidráulica Total Fluide DA, Aditivo de Limpeza do Arrefecimento)
   - Elétrica/Eletrônica (Filtro de Cabine / Ar Condicionado, Bateria Selada)
2. Aplique correções preventivas reais baseadas em Boletins Técnicos (TSBs) da montadora PSA e falhas crônicas conhecidas para esta motorização EW10A e câmbio AL4.
3. Retorne ESTRITAMENTE um array JSON puro, sem formatação markdown (```json), contendo objetos com o formato exato:
[
  {
    "subsistema": "Nome do subsistema (ex: Motor/Trem de Força, Transmissão, Arrefecimento, Freios, Suspensão/Direção, Fluidos/Insumos, Elétrica/Eletrônica)",
    "intervencao": "Nome técnico claro da intervenção preventiva",
    "tipo": "PREVENTIVA",
    "intervalo_km": 40000,
    "intervalo_meses": 24,
    "especificacao_tecnica": "Especificação exata de peças, fluidos (ex: Mobil ATF LT 71141) ou aditivos",
    "origem_fonte": "BOLETIM_TECNICO",
    "texto_precaucao": "Justificativa técnica / Alerta de falha crítica destrutiva / Referência TSB"
  }
]`;
